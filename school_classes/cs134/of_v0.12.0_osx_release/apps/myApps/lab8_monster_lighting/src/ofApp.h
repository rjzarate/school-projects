...
class ofApp : public ofBaseApp{
	...
	public:
		...
		// GUI components
		ofxPanel gui;
		ofParameterGroup keyLightParams, fillLightParams, rimLightParams;

		// Light parameters
		ofParameter<ofVec3f> keyLightPosition;
		ofParameter<float> keyLightCutOff, keyLightIntensity;
		ofParameter<ofVec3f> fillLightPosition;
		ofParameter<float> fillLightCutOff, fillLightIntensity;
		ofParameter<ofVec3f> rimLightPosition;
		ofParameter<float> rimLightCutOff, rimLightIntensity;
};
