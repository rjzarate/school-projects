...
public class Day
{
    ...
    public static final int LEEP_YEARS_DIVISOR = 4;
    public static final int LEEP_YEARS_100 = 100;
    public static final int LEEP_YEARS_400 = 400;
    ...
    {
        if (y % LEEP_YEARS_DIVISOR != 0) 
            return false;
        if (y < GREGORIAN_START_YEAR) 
            return true;
        return (y % LEEP_YEARS_100 != 0) || (y % LEEP_YEARS_400 == 0);
    }
}
